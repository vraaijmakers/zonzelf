# ZonZelf — standalone Next.js build for self-hosted Docker staging.
# See docker-compose.staging.yml for how this is run.
...
# they must be present now, not just at container runtime.
